...
1. **Reproduce** -- run `just bar::migrate::stylua-cleanup-generate`, check test output and/or run integration tests
...
6. **Regenerate** -- `just bar::migrate::stylua-cleanup-generate`, verify all branches pass
7. **Push** -- `just bar::migrate::stylua-cleanup-generate --push --update-prs`
